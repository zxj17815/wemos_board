...
/*-- ID:0,字符:"摄",ASCII编码:C9E3,对应字:宽x高=16x16,画布:宽W=16 高H=16,共32字节*/
...
/*-- ID:1,字符:"氏",ASCII编码:CACF,对应字:宽x高=16x16,画布:宽W=16 高H=16,共32字节*/
...
/*-- ID:3,字符:"力",ASCII编码:C1A6,对应字:宽x高=16x16,画布:宽W=16 高H=16,共32字节*/
...
/*-- ID:4,字符:"≤",ASCII编码:A1DC,对应字:宽x高=16x16,画布:宽W=16 高H=16,共32字节*/
const unsigned char text_font_73[] PROGMEM = {
    0x00, 0x06, 0x00, 0x18, 0x00, 0x60, 0x01, 0x80, 0x06, 0x00, 0x18, 0x00, 0x30, 0x00, 0x18, 0x00, 0x06, 0x00, 0x21, 0x80, 0x18, 0x60, 0x06, 0x18, 0x01, 0x86, 0x00, 0x60, 0x00, 0x18, 0x00, 0x06};

const int text_font_allArray_LEN = 74;
const unsigned char *text_font_allArray[74] = {
    text_font_0,
    text_font_1,
    text_font_2,
    text_font_3,
...
// 晴少云间多阴有风平静微和清强劲疾大烈暴狂爆飓热带霾中度重严阵雨雷并伴冰雹小特极端降毛细雪天气夹冻浮尘扬沙龙卷雾浓轻冷未知无向东北南西旋转不定摄氏力≤"
...
void getData()
{
  if (WiFiMulti.run() == WL_CONNECTED)
  {
    ...
    { // HTTPS
      ...
      if (httpCode > 0)
      {
        ...
        if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY)
        {
          ...
          showBitmap(40, 34, text_font_allArray[textFontMap.at("摄")], 16, 16, ST77XX_YELLOW);
          showBitmap(60, 34, text_font_allArray[textFontMap.at("氏")], 16, 16, ST77XX_YELLOW);
          showBitmap(80, 34, text_font_allArray[textFontMap.at("度")], 16, 16, ST77XX_YELLOW);
          ...
          for (int i = 0; wind[i] != 0; ++i)
          {
            ...
            Serial.println(temp_ch);
            showBitmap(40 + char_index * 20, 54, text_font_allArray[textFontMap.at(temp_ch)], 16, 16, ST77XX_YELLOW);
            char_index++;
            i += 2;
          }
          showBitmap(40 + char_index * 20, 54, text_font_allArray[textFontMap.at("风")], 16, 16, ST77XX_YELLOW);
        }
      }
      else
      {
    ...
    else
    {
      ...
      testdrawtext("[HTTPS] Unable to connect", ST77XX_WHITE);
    }
  }
}
